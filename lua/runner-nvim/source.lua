...
function M.changeCmd(type_command, current_filetype, current_withoutext, realPath, current_filepath, current_filename)
  local getcmd
  if type_command == "cmd" then
    getcmd = Default_config.commands[current_filetype].cmd
  else
    getcmd = Default_config.commands[current_filetype].debug
  end
